...
public class EnumUtil {
	...
	public enum RuleParamCase {
		GRP_SCR_SLC, GRP_SCR_OTHER, GRP_OTHER_SLC, GRP_OTHER_OTHER, OTHER_SRC_SCL, OTHER_SRC_OTHER, OTHER_OTHER_SCL,
		OTHER_OTHER_OTHER;
		...
		public RuleParam getRuleParam(String grpCodeVal, String srcCodeVal, String slcCodeVal) {
			...
			case OTHER_OTHER_OTHER:
				...
				break;
			default:
				throw new AssertionError("Unknown case: " + this);
			}
