...
public class TestComparator {
	...
	public static void main(String[] args) {
		...
		person1.setDob(new GregorianCalendar(1982, Calendar.MAY, 23));
		
		Person person2 = new Person();
		person2.setName("Chris");
		person2.setPercentage(10.14);
		person2.setDob(new GregorianCalendar(1877, Calendar.JUNE, 7));
		
		Person person3 = new Person();
		person3.setName("Parimal");
		person3.setPercentage(79.8);
		person3.setDob(new GregorianCalendar(1981, Calendar.DECEMBER, 15));
		
		Person person4 = new Person();
		person4.setName("Parimal");
		person4.setPercentage(60.9);
		person4.setDob(new GregorianCalendar(1981, Calendar.DECEMBER, 15));
